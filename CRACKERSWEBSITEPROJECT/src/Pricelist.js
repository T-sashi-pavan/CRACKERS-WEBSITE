  ...
  return (
    <Container style={{ padding: '20px' }}>
      <Breadcrumb>
        ...
        <Breadcrumb.Item active>Pricelist</Breadcrumb.Item>
      </Breadcrumb>
          ...
          <Col md={3} key={index}>
            ...
            >
              <Card style={{ width: '100%' }}>
                <Card.Img
                  variant="top"
                  src={`https://www.kausikcrackers.com/image/cache/catalog/new%20arrivels/${index === 0 ? 'Untitled%20design%20(3)' : index === 1 ? 'Untitled%20design%20(9)' : index === 2 ? 'Untitled%20design%20(4)' : index === 3 ? 'Untitled%20design%20(9)' : 'Untitled%20design%20(3)'}-228x228.png `}
