  ...
  return (
    <Container style={{ padding: '20px' }}>
      <Breadcrumb>
        ...
        <Breadcrumb.Item active>Sounds</Breadcrumb.Item>
      </Breadcrumb>
          ...
          <Col md={3} key={index}>
            ...
            >
              <Card style={{ width: '100%' }}>
                <Card.Img                                                                                            
                  variant="top"
                  src={`https://www.kausikcrackers.com/image/cache/catalog/sound%20crackers/${index === 0 ? 'ben10%20(2)' : index === 1 ? 'ben10%20(1)' : index === 2 ? 'kruvi%20(1)' : index === 3 ? 'ben10' : 'kruvi'}-228x228.png `}
