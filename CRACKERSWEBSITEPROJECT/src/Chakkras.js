  ...
  return (
    <Container style={{ padding: '20px' }}>
      <Breadcrumb>
        ...
        <Breadcrumb.Item active>Chakkras</Breadcrumb.Item>
      </Breadcrumb>
          ...
          <Col md={3} key={index}>
            ...
            >
              <Card style={{ width: '100%' }}>
                <Card.Img                                                                                            
                  variant="top"
                  src={`https://www.kausikcrackers.com/image/cache/catalog/Chakkara/${index === 0 ? 'big' : index === 1 ? 'special' : index === 2 ? 'askoa' : index === 3 ? 'Untitled%20design%20(14)' : 'dlx'}-228x228.png `}
