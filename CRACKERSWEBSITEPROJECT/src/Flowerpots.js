  ...
  return (
    <Container style={{ padding: '20px' }}>
      <Breadcrumb>
        ...
        <Breadcrumb.Item active>Flowerpots</Breadcrumb.Item>
      </Breadcrumb>
          ...
          <Col md={3} key={index}>
            ...
            >
              <Card style={{ width: '100%' }}>
                <Card.Img                                                                                            
                  variant="top"
                  src={`https://www.kausikcrackers.com/image/cache/catalog/flowerpots/${index === 0 ? 'Untitled%20design%20(10)' : index === 1 ? 'ben10' : index === 2 ? 'flowerpotsdlx' : index === 3 ? 'colorkotidlx' : 'colorkoti'}-228x228.png `}
