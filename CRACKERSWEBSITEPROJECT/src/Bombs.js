  ...
  return (
    <Container style={{ padding: '20px' }}>
      <Breadcrumb>
        ...
        <Breadcrumb.Item active>Bombs</Breadcrumb.Item>
      </Breadcrumb>
          ...
          <Col md={3} key={index}>
            ...
            >
              <Card style={{ width: '100%' }}>
                <Card.Img                                                                                            
                  variant="top"
                  src={`https://www.kausikcrackers.com/image/cache/catalog/bombs/${index === 0 ? 'Untitled%20design%20(13)' : index === 1 ? 'atombomb' : index === 2 ? 'hydrobomb' : index === 3 ? 'angibomb' : 'classicbomb'}-228x228.png `}
